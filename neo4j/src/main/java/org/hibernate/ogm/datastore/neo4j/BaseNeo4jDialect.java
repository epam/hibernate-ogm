...
public abstract class BaseNeo4jDialect<E extends BaseNeo4jEntityQueries, A extends BaseNeo4jAssociationQueries> extends BaseGridDialect
	...
	protected Pair<String, Map> buildProcedureQueryWithParams(String storedProcedureName, ProcedureQueryParameters queryParameters) {
		...
		return new Pair<String, Map>( queryBuilder.toString(), namedParams );
	}
