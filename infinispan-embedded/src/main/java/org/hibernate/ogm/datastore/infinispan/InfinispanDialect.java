 ...
 */
public class InfinispanDialect<EK,AK,ISK> extends BaseGridDialect implements StoredProcedureAwareGridDialect {
	...
	private static Callable<?> instantiate(String storedProcedureName, String className) {
		try {
			return (Callable<?>) ReflectionHelper.instantiate( className );
		}
